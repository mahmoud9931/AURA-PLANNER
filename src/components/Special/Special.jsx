...
export default function Special() {
    ...
    const fetchVenues = () => {
        setLoading(true);
        axios.get(`${API_BASE}/api/special-events`)
            .then((res) => {
    ...
    const handleAdd = async (e) => {
        ...
        setSubmitting(true);
        try {
            await axios.post(`${API_BASE}/api/special-events`, { ...formData, type: "special" }, getAuthHeaders());
    ...
    const handleEdit = async (e) => {
        ...
        setSubmitting(true);
        try {
            await axios.put(`${API_BASE}/api/special-events/${selectedVenue._id}`, { ...formData, type: "special" }, getAuthHeaders());
    ...
    const handleDelete = async (venueId, venueName) => {
        ...
        try {
            await axios.delete(`${API_BASE}/api/special-events/${venueId}`, getAuthHeaders());
            fetchVenues();
        } catch (err) {
        ...
        <>
            ...
            <section className="venues-section">
                <div className="venues-title-row">
                    <h1 className="venues-title">Special Events Ideas</h1>
                    {isAdmin && (
                ...
                <div className="modal-overlay" onClick={() => setShowAddModal(false)}>
                    <div className="modal-box" onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <h2 className="modal-title">➕ Add Special Event Idea</h2>
    ...
    return (
        <>
            <div className="form-group">
                ...
                <input className="form-input" type="text" name="name" value={formData.name} onChange={handleChange} placeholder="e.g. VIP Gala Night" required />
            </div>
            <div className="form-group">
