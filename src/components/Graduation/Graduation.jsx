...
export default function Graduation() {
    ...
    const fetchVenues = () => {
        setLoading(true);
        axios.get(`${API_BASE}/api/graduations`)
            .then((res) => {
    ...
    const handleAdd = async (e) => {
        ...
        setSubmitting(true);
        try {
            await axios.post(`${API_BASE}/api/graduations`, { ...formData, type: "graduation" }, getAuthHeaders());
    ...
    const handleEdit = async (e) => {
        ...
        setSubmitting(true);
        try {
            await axios.put(`${API_BASE}/api/graduations/${selectedVenue._id}`, { ...formData, type: "graduation" }, getAuthHeaders());
    ...
    const handleDelete = async (venueId, venueName) => {
        ...
        try {
            await axios.delete(`${API_BASE}/api/graduations/${venueId}`, getAuthHeaders());
            fetchVenues();
        } catch (err) {
        ...
        <>
            ...
            <section className="venues-section">
                <div className="venues-title-row">
                    <h1 className="venues-title">Graduation Ideas</h1>
                    {isAdmin && (
                ...
                <div className="modal-overlay" onClick={() => setShowAddModal(false)}>
                    <div className="modal-box" onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <h2 className="modal-title">➕ Add Graduation Idea</h2>
    ...
    return (
        <>
            <div className="form-group">
                ...
                <input className="form-input" type="text" name="name" value={formData.name} onChange={handleChange} placeholder="e.g. Rooftop Graduation Party" required />
            </div>
            <div className="form-group">
